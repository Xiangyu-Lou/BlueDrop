...
set RELEASE_DIR=F:\Project\BlueDrop\release\BlueDrop-v0.2.0
...
powershell -Command "Compress-Archive -Path 'BlueDrop-v0.2.0' -DestinationPath 'BlueDrop-v0.2.0-win64.zip' -Force"

echo === DONE: release\BlueDrop-v0.2.0-win64.zip ===
