...
set RELEASE_DIR=F:\Project\BlueDrop\release\BlueDrop-v0.1.5
...
powershell -Command "Compress-Archive -Path 'BlueDrop-v0.1.5' -DestinationPath 'BlueDrop-v0.1.5-win64.zip' -Force"

echo === DONE: release\BlueDrop-v0.1.5-win64.zip ===
