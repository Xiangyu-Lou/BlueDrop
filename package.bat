...
set RELEASE_DIR=F:\Project\BlueDrop\release\BlueDrop-v0.1.4
...
powershell -Command "Compress-Archive -Path 'BlueDrop-v0.1.4' -DestinationPath 'BlueDrop-v0.1.4-win64.zip' -Force"

echo === DONE: release\BlueDrop-v0.1.4-win64.zip ===
